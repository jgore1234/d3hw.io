...
var svg = d3.select(“#scatter”) // d3.select() the id “#scatter” element
            ...
            .classed(“class”, “chart”); // give it a class of “chart”
...
var yText = svg.append(“g”) // append a ‘g’ element to the svg
                .attr(“class”, “yText”); //give it a class of yText
...
yText.append(“text”) // append a “text” element to the yText group
      ...
      .attr(“class”, “axisText inactive y”)  // give it class of axisText, active, and y
...
d3.csv(“assets/data/data.csv”).then(function(dataset) {
  ...
  // Visualize the data
  visualize(dataset); // call your visualize() function on the data
});
...
// Determine x and y tick counts.
  ...
  circlesGroup.append(“circle”) // append a ‘circle’ element to the circlesGroup
            ...
            .attr(“class”, d => `stateCircle ${d.abbr}`) // set the class attr() to map from d => the d.abbr
            .on(“mouseover”, function (d) { // .on ‘mouseover’ event, fire off a function that takes argument d
              ...
              d3.select(this).attr(“stroke”, “blue”); // use d3.select() the this element, and modify the ‘stroke’ .style() to a color of your choosing
            })
            .on(“mouseout”, function (d) { // on ‘mouseout’ fire off a function that takes argument d
              ...
              toolTip.hide(d, this); // use toolTip.hide() with d and this as the arguments
                // Remove highlight
              d3.select(this).attr(“stroke”, “green”); // use d3.select() the this element, and modify the ‘stroke’ .style() to another color of your choosing
            });
  ...
  circlesGroup.append(“text”) // append a ‘text’ element to circlesGroup
              ...
              .on(“mouseover”, function(d) { // on ‘mouseover’ event, fire off a function that takes argument d
                ...
                d3.select(this).attr(“stoke”, “yellow”); // use d3.select() the this element, and modify the ‘stroke’ .style() to a color of your choosing
              })
              .on(“mouseout”, function(d) { // on ‘mouseout’ fire off a function that takes argument d
                  // Remove the tooltip
                  toolTip.hide(d, this); // use toolTip.hide() with d and this as the arguments
                  // Remove highlight
                  d3.select(this).attr(“stroke”, “purple”); // use d3.select() the this element, and modify the ‘stroke’ .style() to another color of your choosing
              });
  // Make Graph Dynamics
  // ==========================
  ...
  function resizeChart() { // define a function called resizeChart that takes no arguments
    ...
    d3.selectAll(“circle”) // d3.selectAll() ‘circle’ elements
      ...
      .attr(“cy”, xScale(d[currentX])) // set the ‘cy’ attribute to use the xScale() d[currentX]
